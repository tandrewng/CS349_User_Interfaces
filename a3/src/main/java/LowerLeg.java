...
public class LowerLeg extends Appendage{
    ...
    private UpperLeg parent = null;

    // Creates a rectangle based at the origin with the specified width and height
    public LowerLeg(int x, int y, int width, int height, boolean isLeft, UpperLeg p) {
        super();
        instance = ++instanceCount;
        parent = p;
        Image img = new Image("LowerLeg.png");
